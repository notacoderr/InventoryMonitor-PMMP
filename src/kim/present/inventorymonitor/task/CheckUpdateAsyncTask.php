...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/InventoryMonitor-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = InventoryMonitor::getInstance()->getDataFolder() . ".latestCache";
	}
